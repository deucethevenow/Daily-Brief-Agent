...
class SlackClient:
    ...
    def send_team_mention_summary(self, user_tasks: List[Dict[str, Any]], date_str: str) -> Dict[str, Any]:
        """Send a clean summary of unanswered mentions to the #team channel.

        Posts ONE message listing each person who has unanswered mentions,
        @mentioning them and linking to their Asana task.
        ...
        blocks = [
            ...
            },
            {
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": "The following team members have Asana comments that need responses:"
                }
            },
            {"type": "divider"}
        ]
        ...
        for entry in user_tasks:
            ...
            # @mention if we have their Slack ID, otherwise just use name
            ...
            blocks.append({
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": f"{user_ref} — {count} {comment_word} need{'s' if count == 1 else ''} a response\n:point_right: <{task_url}|View & respond in Asana>"
                }
            })
        ...
        try:
            ...
            logger.info(f"Team mention summary sent to {self.team_channel_id} ({len(user_tasks)} users)")
            return response
        except SlackApiError as e:
